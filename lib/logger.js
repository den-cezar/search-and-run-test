 ...
 *
 * The active level is read from chrome.storage.sync ("log_level") when available
 * and defaults to "info". Set "debug" from the Options page to see verbose logs.
 */
